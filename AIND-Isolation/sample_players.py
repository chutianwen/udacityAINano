...
if __name__ == "__main__":
    ...
    player1 = Agent(HumanPlayer(), name="Tianwen")
    player2 = Agent(HumanPlayer(), name="Jing")
    game = Board(player1.player, player2.player)
    # game.play(10000)
    ...
    winner, history, outcome = game.play(1000000)
